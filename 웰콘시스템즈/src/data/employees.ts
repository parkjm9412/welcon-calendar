...
export const employees: Employee[] = [
  { id: 'e01', name: '박상덕', email: 'sdpark@welconsystems.com',   site: '본사',  dept: 'CEO',       role: '대표이사',     rank: '대표이사', status: 'active', isAdmin: false },
  { id: 'e02', name: '박기덕', email: 'ican6070@welconsystems.com', site: '본사',  dept: '경영기획본부', role: '전무',         rank: '전무',     status: 'active', isAdmin: false },
  { id: 'e03', name: '신은철', email: 'ecshin@welconsystems.com',   site: '연구소', dept: 'R&D센터',   role: '부사장',       rank: '부사장',   status: 'active', isAdmin: false },
  ...
  { id: 'e07', name: '박종미', email: 'pjm@welconsystems.com',      site: '본사',  dept: 'S&M센터',    role: 'CS팀장',       rank: '팀장',     status: 'active', isAdmin: true  },
